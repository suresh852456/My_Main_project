...
def print_and_accept(pkt):
        ...
        dst_port = struct.unpack('>H', pl[tcp_offset+4:tcp_offset+6])[0]
        print 'from {}:{},to {}:{} with {} protocol'.format(ip_to_string(src_ip), src_port,ip_to_string(dst_ip),dst_port,protocol)
        pkt.accept()
